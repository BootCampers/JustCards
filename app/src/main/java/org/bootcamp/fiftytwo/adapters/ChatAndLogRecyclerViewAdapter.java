 ...
 */
public class ChatAndLogRecyclerViewAdapter extends RecyclerView.Adapter<ChatAndLogRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;
    private final ChatAndLogFragment.OnListFragmentInteractionListener mListener;

    public ChatAndLogRecyclerViewAdapter(List<DummyItem> items, ChatAndLogFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_chatandlog, parent, false);
